...
public class BeastformResponse implements Restrictable {
    ...
    /**
     * Name of the expansion this beastform belongs to (always included). On a redacted stub,
     * this is the only content-identifying field carried, so the frontend can tell the viewer
     * which book to buy without exposing the beastform's real content.
     */
